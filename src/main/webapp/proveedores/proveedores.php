        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card" style="height: 40rem">
                <div class="card-header">
                    <br>
                    <h3 align=center>SELECCIONE PROVEEDOR A ELIMINAR</h3>
                ...
                <div class="card-body">
                    ...
                    while ($reg = mysqli_fetch_array($registros)) {
                        $dato = $reg['ProNit'];
                        if ($contador % 2 == 0) {
                            echo "<form action=updateprov.php method='post'>";
                            echo "<button name='cedula' type='submit' class='btn btn-light btn-lg border' value=$dato>" . "Identificación:\t" . $reg['ProNit'] . "\tNombre:\t" . $reg['ProRazonSocial'] . "</button>";
                            echo "</form>";
                        } else {
                            echo "<form action=pdateprov.php method='post'>";
                            echo "<button name='cedula' type='submit' class='btn btn-secondary btn-lg' value=$dato>" . "Identificación:\t" . $reg['ProNit'] . "\tNombre:\t" . $reg['ProRazonSocial'] . "</button>";
                            echo "</form>";
                        }
                        $contador++;
                    }
