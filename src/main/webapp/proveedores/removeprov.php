        ...
        <div class="d-flex justify-content-center h-100">
			...
			window.location="listprov.php";</script>';
                        ...
                        while ($reg = mysqli_fetch_array($registros)) {
                            echo "<div class='bg-white'><h6 class='bg-light'>Nombre:\t" . $reg['ProRazonSocial'] . "</h6>";
                            echo "<div class='bg-white'><label for='cedula' class='bg-white'>NIT:\t</label><input class=' bg-white border-0' type='text' name='cedula' value=$reg[ProNit] >" . "</div>";
                            echo "<h6 class='bg-light'>Dirección:\t" . $reg['ProDireccion'] . "</h6>";
                            echo "<h6 class='bg-white'>Teléfono:\t" . $reg['ProTelefono'] . "</h6>";
                            echo "<h6 class='bg-light'>Ciudad:\t" . $reg['ProCiudad'] . "</h6>";
                            echo "<h6 class='bg-white'>Pais:\t" . $reg['ProPais'] . "</h6></div>";
                        }
                        mysqli_close($conexion);
                        ?>
                        <br>
                        <div class="form-group row justify-content-center">
                            <input type="button" value="Cancelar" class="btn btn-success w-25 me-2" onclick="location='listprov.php'">
