        ...
        <div class="d-flex justify-content-center h-100">
			...
			window.location="empleados.php";</script>';
                        ...
                        while ($reg = mysqli_fetch_array($registros)) {
                            ...
                            echo "<div class='bg-white'><label for='cedula' class='bg-white w-25' style='text-align:center'>Identificación:\t</label><input  style='text-align:center' class='input-sm bg-white w-75' type='text' name='cedula' value='$reg[EmpCedula]'>" . "</div>";
                            echo "<div class='bg-light'><label for='nombre' class='bg-light w-25'  style='text-align:center'>Nombre:\t</label><input class='input-sm bg-light w-75'  style='text-align:center' type='text' name='nombre' value='$reg[EmpNombre]'>" . "</div>";
                            echo "<div class='bg-white'><label for='direccion' class='bg-white w-25'  style='text-align:center'>Dirección:</label><input class='input-sm bg-white w-75'  style='text-align:center' type='text' name='direccion' value='$reg[EmpDireccion]'>" . "</div>";
                            echo "<div class='bg-light'><label for='telefono' class='bg-light w-25'  style='text-align:center'>Teléfono:</label><input class='input-sm bg-light w-75'  style='text-align:center' type='text' name='telefono' value='$reg[EmpTelefono]'>" . "</div>";
                            echo "<div class='bg-white'><label for='ciudad' class='bg-white w-25'  style='text-align:center'>Ciudad:</label><input class='input-sm bg-white w-75'  style='text-align:center' type='text' name='ciudad' value='$reg[EmpCiudad]'>" . "</div>";
                            echo "<div class='bg-light'><label for='cargo' class='bg-light w-25'  style='text-align:center'>Cargo:</label><input class='input-sm bg-light w-75'  style='text-align:center' type='text' name='cargo' value='$reg[EmpCargo]'>" . "</div>";
                            echo "<div class='bg-white'><label for='contrato' class='bg-white w-25'  style='text-align:center'>Contrato:</label><input class='input-sm bg-white w-75'  style='text-align:center' type='text' name='contrato' value='$reg[EmpContrato]'>" . "</div>";
                            echo "<div class='bg-light'><label for='sueldo' class='bg-light w-25'  style='text-align:center'>Salario:</label><input class='input-sm bg-light w-75'  style='text-align:center' type='text' name='sueldo' value='$reg[EmpSueldo]'>" . "</div>";
                            echo "<div class='bg-white'><label for='eps' class='bg-white w-25'  style='text-align:center'>EPS:</label><input class='input-sm bg-white w-75'  style='text-align:center' type='text' name='eps' value='$reg[EmpEPS]'>" . "</div>";
                            echo "<div class='bg-light'><label for='arl' class='bg-light w-25'  style='text-align:center'>ARL:</label><input class='input-sm bg-light w-75'  style='text-align:center' type='text' name='arl' value='$reg[EmpARL]'>" . "</div>";
                            echo "<div class='bg-white'><label for='ccf' class='bg-white w-25'  style='text-align:center'>CCF:</label><input class='input-sm bg-white w-75'  style='text-align:center' type='text' name='ccf' value='$reg[EmpCCF]'>" . "</div></div>";
                        }
                        mysqli_close($conexion);
                        ?>
                        <br>
                        <div class="form-group row justify-content-center">
                            <input type="button" value="Cancelar" class="btn btn-success w-25 me-2" onclick="location='empleados.php'">
