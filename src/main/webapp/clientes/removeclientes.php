        ...
        <div class="d-flex justify-content-center h-100">
			...
			window.location="listclientes.php";</script>';
                        ...
                        while ($reg = mysqli_fetch_array($registros)) {
                            echo "<div class='bg-white'><h6 class='bg-light'>Usuario:\t" . $reg['CliUsuario'] . "</h6>";
                            echo "<div class='bg-white'><label for='cedula' class='bg-white'>Identificación:\t</label><input class='input-sm bg-white border-0' type='text' name='cedula' value=$reg[CliNit]>" . "</div>";
                            echo "<h6 class='bg-light'>Nombre:\t" . $reg['CliRazonSocial'] . "</h6>";
                            echo "<h6 class='bg-white'>Dirección:\t" . $reg['CliDireccion'] . "</h6>";
                            echo "<h6 class='bg-light'>Teléfono:\t" . $reg['CliTelefono'] . "</h6>";
                            echo "<h6 class='bg-white'>Ciudad:\t" . $reg['CliCiudad'] . "</h6>";
                            echo "<h6 class='bg-light'>Pais:\t" . $reg['CliPais'] . "</h6></div>";
                        }
                        mysqli_close($conexion);
                        ?>
                        <br>
                        <div class="form-group row justify-content-center">
                            <input type="button" value="Cancelar" class="btn btn-success w-25 me-2" onclick="location='listclientes.php'">
