        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card" style="width: 40rem">
                ...
                <div class="card-body">
                    <form action=update.php method="post">
                        ...
                        $registros = mysqli_query($conexion, "select * from clientes where CliNit='$_REQUEST[cedula]'") or
			...
			window.location="listclientes.php";</script>';
                        ...
                        while ($reg = mysqli_fetch_array($registros)) {
                            echo "<div class='bg-white'><label class='bg-light w-25' style='text-align:center'>Usuario:</label><label class='bg-light w-75' style='text-align:center'>" . $reg['CliUsuario'] . "</label>";
                            echo "<div class='bg-white'><label for='cedula' class='bg-white w-25' style='text-align:center'>Identificación:\t</label><input  style='text-align:center' class='input-sm bg-white w-75' type='text' name='cedula' value='$reg[CliNit]'>" . "</div>";
                            echo "<div class='bg-light'><label for='nombre' class='bg-light w-25'  style='text-align:center'>Nombre:\t</label><input class='input-sm bg-light w-75'  style='text-align:center' type='text' name='nombre' value='$reg[CliRazonSocial]'>" . "</div>";
                            echo "<div class='bg-white'><label for='direccion' class='bg-white w-25'  style='text-align:center'>Dirección:</label><input class='input-sm bg-white w-75'  style='text-align:center' type='text' name='direccion' value='$reg[CliDireccion]'>" . "</div>";
                            echo "<div class='bg-light'><label for='telefono' class='bg-light w-25'  style='text-align:center'>Teléfono:</label><input class='input-sm bg-light w-75'  style='text-align:center' type='text' name='telefono' value='$reg[CliTelefono]'>" . "</div>";
                            echo "<div class='bg-white'><label for='ciudad' class='bg-white w-25'  style='text-align:center'>Ciudad:</label><input class='input-sm bg-white w-75'  style='text-align:center' type='text' name='ciudad' value='$reg[CliCiudad]'>" . "</div>";
                            echo "<div class='bg-light'><label for='pais' class='bg-light w-25'  style='text-align:center'>Pais:</label><input class='input-sm bg-light w-75'  style='text-align:center' type='text' name='pais' value='$reg[CliPais]'>" . "</div></div>";
                        }
                        mysqli_close($conexion);
                        ?>
                        <br>
                        <div class="form-group row justify-content-center">
                            <input type="button" value="Cancelar" class="btn btn-success w-25 me-2" onclick="location='clientes.php'">
