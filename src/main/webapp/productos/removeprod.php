        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                <div class="card-header">
                    <br>
                    <h5 class="bg-danger" align=center>VA A ELIMINAR ESTE PRODUCTO? NO SE PODRÁ RECUPERAR</h5>
                ...
                <div class="card-body">
                    <form action=delete.php method="post">
                        ...
                        if (mysqli_num_rows($registros) == 0) {
                            echo '<script type="text/javascript">alert("Producto no existe")
			window.location="listprod.php";</script>';
                        }

                        while ($reg = mysqli_fetch_array($registros)) {
                            echo "<div class='bg-white'><input class='input-sm bg-white border-0' type='hidden' name='nombre' value=$reg[ProdID]>" . "</div>";
                            echo "<div class='bg-white'><h6 class='bg-light'>Nombre:\t" . $reg['ProNombre'] . "</h6>";
                            echo "<h6 class='bg-light'>Precio:\t" . $reg['ProPrecio'] . "</h6>";
                            echo "<h6 class='bg-white'>Detalle:\t" . $reg['Prodetalle'] . "</h6></div>";
                        }
                        mysqli_close($conexion);
                        ?>
                        <br>
                        <div class="form-group row justify-content-center">
                            <input type="button" value="Cancelar" class="btn btn-success w-25 me-2" onclick="location='listprod.php'">
